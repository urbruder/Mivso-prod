---
name: rental-application-screening
description: "Use this skill whenever an agent needs a rental application screening, asks to build a rental application screening, or needs help with this catalog job: Fair-Housing-safe screening criteria and adverse-action templates. Produces an Excel workbook for Rental Application Screening."
---
...
Creates a finished Excel workbook for Rental Application Screening. It helps the agent handle this catalog job: Fair-Housing-safe screening criteria and adverse-action templates. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a rental application screening"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Fair-Housing-safe screening criteria and adverse-action templates.
...
- "Build a rental application screening"
- "Create a client-ready rental application screening"
- "Turn these notes into a rental application screening"
- "Help me prepare a rental application screening for my next real estate conversation"
- "I need a polished rental application screening deliverable"
