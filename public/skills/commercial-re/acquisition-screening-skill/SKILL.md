---
name: acquisition-screening-skill
description: "Use this skill whenever an agent needs an acquisition screening, asks to build an acquisition screening, or needs help with this catalog job: Buy-box, comp logic, and kill-criteria for a fast first-pass memo. Produces an Excel workbook for Acquisition Screening Skill."
---
...
Creates a finished Excel workbook for Acquisition Screening Skill. It helps the agent handle this catalog job: Buy-box, comp logic, and kill-criteria for a fast first-pass memo. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build an acquisition screening"
...
## Output Format
An Excel workbook named Acquisition_Screening_Skill_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Acquisition Screening Skill; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Buy-box, comp logic, and kill-criteria for a fast first-pass memo.
...
- "Build an acquisition screening"
- "Create a client-ready acquisition screening"
- "Turn these notes into an acquisition screening"
- "Help me prepare an acquisition screening for my next real estate conversation"
- "I need a polished acquisition screening deliverable"
