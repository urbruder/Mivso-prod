---
name: due-diligence-review-skill
description: "Use this skill whenever an agent needs a due diligence review, asks to build a due diligence review, or needs help with this catalog job: DD checklist, document index, red-flag library, and summary memo. Produces an Excel workbook for Due Diligence Review Skill."
---
...
Creates a finished Excel workbook for Due Diligence Review Skill. It helps the agent handle this catalog job: DD checklist, document index, red-flag library, and summary memo. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a due diligence review"
...
## Output Format
An Excel workbook named Due_Diligence_Review_Skill_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Due Diligence Review Skill; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: DD checklist, document index, red-flag library, and summary memo.
...
- "Build a due diligence review"
- "Create a client-ready due diligence review"
- "Turn these notes into a due diligence review"
- "Help me prepare a due diligence review for my next real estate conversation"
- "I need a polished due diligence review deliverable"
