---
name: lease-abstract-skill
description: "Use this skill whenever an agent needs a lease abstract, asks to build a lease abstract, or needs help with this catalog job: Extracts an 80–126-field abstract with clause definitions and red flags. Produces an Excel workbook for Lease Abstract Skill."
---
...
Creates a finished Excel workbook for Lease Abstract Skill. It helps the agent handle this catalog job: Extracts an 80–126-field abstract with clause definitions and red flags. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a lease abstract"
...
## Output Format
An Excel workbook named Lease_Abstract_Skill_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Lease Abstract Skill; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Extracts an 80–126-field abstract with clause definitions and red flags.
...
- "Build a lease abstract"
- "Create a client-ready lease abstract"
- "Turn these notes into a lease abstract"
- "Help me prepare a lease abstract for my next real estate conversation"
- "I need a polished lease abstract deliverable"
