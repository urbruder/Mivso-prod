---
name: 1031-cap-gains-guardrail
description: "Use this skill whenever an agent needs a 1031 and cap-gains guardrail, asks to build a 1031 and cap-gains guardrail, or needs help with this catalog job: Explains tax mechanisms conceptually with a built-in 'consult your CPA' disclaimer. Produces a Word document for 1031 / Cap-Gains Guardrail."
---
...
Creates a finished Word document for 1031 / Cap-Gains Guardrail. It helps the agent handle this catalog job: Explains tax mechanisms conceptually with a built-in 'consult your CPA' disclaimer. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a 1031 and cap-gains guardrail"
...
## Output Format
A Word document named 1031_Cap_Gains_Guardrail_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main 1031 / Cap-Gains Guardrail deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Explains tax mechanisms conceptually with a built-in 'consult your CPA' disclaimer.
...
- "Build a 1031 and cap-gains guardrail"
- "Create a client-ready 1031 and cap-gains guardrail"
- "Turn these notes into a 1031 and cap-gains guardrail"
- "Help me prepare a 1031 and cap-gains guardrail for my next real estate conversation"
- "I need a polished 1031 and cap-gains guardrail deliverable"
