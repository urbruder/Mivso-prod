...
description: "Use this skill whenever an agent needs a broker-to-broker referral agreement, asks to build a broker-to-broker referral agreement, or needs help with this catalog job: Clear cross-market referral agreements with timelines and payout terms. Produces a Word document for Broker-to-Broker Referral Agreement."
---
...
Creates a finished Word document for Broker-to-Broker Referral Agreement. It helps the agent handle this catalog job: Clear cross-market referral agreements with timelines and payout terms. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a broker-to-broker referral agreement"
...
## Output Format
A Word document named Broker_to_Broker_Referral_Agreement_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Broker-to-Broker Referral Agreement deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Clear cross-market referral agreements with timelines and payout terms.
...
- "Build a broker-to-broker referral agreement"
- "Create a client-ready broker-to-broker referral agreement"
- "Turn these notes into a broker-to-broker referral agreement"
- "Help me prepare a broker-to-broker referral agreement for my next real estate conversation"
- "I need a polished broker-to-broker referral agreement deliverable"
