---
name: zoning-and-adu-change-briefer
description: "Use this skill whenever an agent needs a zoning & adu change briefer, asks to build a zoning & adu change briefer, or needs help with this catalog job: Extracts the bottom-line impact of zoning/ADU changes from council docs. Produces a Word document for Zoning & ADU Change Briefer."
---
...
Creates a finished Word document for Zoning & ADU Change Briefer. It helps the agent handle this catalog job: Extracts the bottom-line impact of zoning/ADU changes from council docs. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a zoning & adu change briefer"
...
## Output Format
A Word document named Zoning_ADU_Change_Briefer_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Zoning & ADU Change Briefer deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Extracts the bottom-line impact of zoning/ADU changes from council docs.
...
- "Build a zoning & adu change briefer"
- "Create a client-ready zoning & adu change briefer"
- "Turn these notes into a zoning & adu change briefer"
- "Help me prepare a zoning & adu change briefer for my next real estate conversation"
- "I need a polished zoning & adu change briefer deliverable"
