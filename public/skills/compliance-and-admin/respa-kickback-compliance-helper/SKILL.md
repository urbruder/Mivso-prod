---
name: respa-kickback-compliance-helper
description: "Use this skill whenever an agent needs a respa kickback compliance helper, asks to build a respa kickback compliance helper, or needs help with this catalog job: Tracks referral fees and MSAs to avoid Section 8 violations. Produces an Excel workbook for RESPA Kickback Compliance Helper."
---
...
Creates a finished Excel workbook for RESPA Kickback Compliance Helper. It helps the agent handle this catalog job: Tracks referral fees and MSAs to avoid Section 8 violations. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a respa kickback compliance helper"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Tracks referral fees and MSAs to avoid Section 8 violations.
...
- "Build a respa kickback compliance helper"
- "Create a client-ready respa kickback compliance helper"
- "Turn these notes into a respa kickback compliance helper"
- "Help me prepare a respa kickback compliance helper for my next real estate conversation"
- "I need a polished respa kickback compliance helper deliverable"
