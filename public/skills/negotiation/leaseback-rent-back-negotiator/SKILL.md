---
name: leaseback-rent-back-negotiator
description: "Use this skill whenever an agent needs a leaseback and rent-back negotiator, asks to build a leaseback and rent-back negotiator, or needs help with this catalog job: Structures post-closing occupancy for sellers who need time. Produces a Word document for Leaseback / Rent-Back Negotiator. This is an extended catalog skill."
---
...
Creates a finished Word document for Leaseback / Rent-Back Negotiator. It helps the agent handle this catalog job: Structures post-closing occupancy for sellers who need time. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a leaseback and rent-back negotiator"
...
## Output Format
A Word document named Leaseback_Rent_Back_Negotiator_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Leaseback / Rent-Back Negotiator deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Structures post-closing occupancy for sellers who need time.
...
- "Build a leaseback and rent-back negotiator"
- "Create a client-ready leaseback and rent-back negotiator"
- "Turn these notes into a leaseback and rent-back negotiator"
- "Help me prepare a leaseback and rent-back negotiator for my next real estate conversation"
- "I need a polished leaseback and rent-back negotiator deliverable"
