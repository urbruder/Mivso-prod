---
name: contingent-offer-strategy-helper
description: "Use this skill whenever an agent needs a contingent-offer strategy helper, asks to build a contingent-offer strategy helper, or needs help with this catalog job: Structures buy-before-sell and home-sale-contingent offers to compete. Produces a Word document for Contingent-Offer Strategy Helper. This is an extended catalog skill."
---
...
Creates a finished Word document for Contingent-Offer Strategy Helper. It helps the agent handle this catalog job: Structures buy-before-sell and home-sale-contingent offers to compete. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a contingent-offer strategy helper"
...
## Output Format
A Word document named Contingent_Offer_Strategy_Helper_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Contingent-Offer Strategy Helper deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Structures buy-before-sell and home-sale-contingent offers to compete.
...
- "Build a contingent-offer strategy helper"
- "Create a client-ready contingent-offer strategy helper"
- "Turn these notes into a contingent-offer strategy helper"
- "Help me prepare a contingent-offer strategy helper for my next real estate conversation"
- "I need a polished contingent-offer strategy helper deliverable"
