---
name: repair-request-and-credit-negotiator
description: "Use this skill whenever an agent needs a repair-request & credit negotiator, asks to build a repair-request & credit negotiator, or needs help with this catalog job: Contractor-quote-backed repair and credit asks that keep deals alive. Produces a Word document for Repair-Request & Credit Negotiator."
---
...
Creates a finished Word document for Repair-Request & Credit Negotiator. It helps the agent handle this catalog job: Contractor-quote-backed repair and credit asks that keep deals alive. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a repair-request & credit negotiator"
...
## Output Format
A Word document named Repair_Request_Credit_Negotiator_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Repair-Request & Credit Negotiator deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Contractor-quote-backed repair and credit asks that keep deals alive.
...
- "Build a repair-request & credit negotiator"
- "Create a client-ready repair-request & credit negotiator"
- "Turn these notes into a repair-request & credit negotiator"
- "Help me prepare a repair-request & credit negotiator for my next real estate conversation"
- "I need a polished repair-request & credit negotiator deliverable"
