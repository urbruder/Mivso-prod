---
name: counteroffer-strategist
description: "Use this skill whenever an agent needs a counteroffer strategist, asks to build a counteroffer strategist, or needs help with this catalog job: Talking points and a concession plan for any offer or counter scenario. Produces a Word document for Counteroffer Strategist."
---
...
Creates a finished Word document for Counteroffer Strategist. It helps the agent handle this catalog job: Talking points and a concession plan for any offer or counter scenario. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a counteroffer strategist"
...
## Output Format
A Word document named Counteroffer_Strategist_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Counteroffer Strategist deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Talking points and a concession plan for any offer or counter scenario.
...
- "Build a counteroffer strategist"
- "Create a client-ready counteroffer strategist"
- "Turn these notes into a counteroffer strategist"
- "Help me prepare a counteroffer strategist for my next real estate conversation"
- "I need a polished counteroffer strategist deliverable"
