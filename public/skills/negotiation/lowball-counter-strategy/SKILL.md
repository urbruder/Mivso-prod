---
name: lowball-counter-strategy
description: "Use this skill whenever an agent needs a lowball counter-strategy, asks to build a lowball counter-strategy, or needs help with this catalog job: Desensitizes offended sellers and reframes toward a data-driven counter. Produces a Word document for Lowball Counter-Strategy."
---
...
Creates a finished Word document for Lowball Counter-Strategy. It helps the agent handle this catalog job: Desensitizes offended sellers and reframes toward a data-driven counter. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a lowball counter-strategy"
...
6. Convert the source material into a polished Word document that directly supports this job: Desensitizes offended sellers and reframes toward a data-driven counter.
...
- "Build a lowball counter-strategy"
- "Create a client-ready lowball counter-strategy"
- "Turn these notes into a lowball counter-strategy"
- "Help me prepare a lowball counter-strategy for my next real estate conversation"
- "I need a polished lowball counter-strategy deliverable"
