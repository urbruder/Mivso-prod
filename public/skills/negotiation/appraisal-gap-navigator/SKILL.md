---
name: appraisal-gap-navigator
description: "Use this skill whenever an agent needs an appraisal gap navigator, asks to build an appraisal gap navigator, or needs help with this catalog job: Resolution frameworks that save deals when a home appraises low. Produces a Word document for Appraisal Gap Navigator. This is a strategic catalog skill."
---
...
Creates a finished Word document for Appraisal Gap Navigator. It helps the agent handle this catalog job: Resolution frameworks that save deals when a home appraises low. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build an appraisal gap navigator"
...
6. Convert the source material into a polished Word document that directly supports this job: Resolution frameworks that save deals when a home appraises low.
...
- "Build an appraisal gap navigator"
- "Create a client-ready appraisal gap navigator"
- "Turn these notes into an appraisal gap navigator"
- "Help me prepare an appraisal gap navigator for my next real estate conversation"
- "I need a polished appraisal gap navigator deliverable"
