---
name: multiple-offer-manager
description: "Use this skill whenever an agent needs a multiple-offer management plan, asks to build a multiple-offer management plan, or needs help with this catalog job: Scripts and a fair, defensible process for running a bidding war. Produces an Excel workbook for Multiple-Offer Manager."
---
...
Creates a finished Excel workbook for Multiple-Offer Manager. It helps the agent handle this catalog job: Scripts and a fair, defensible process for running a bidding war. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a multiple-offer management plan"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Scripts and a fair, defensible process for running a bidding war.
...
- "Build a multiple-offer management plan"
- "Create a client-ready multiple-offer management plan"
- "Turn these notes into a multiple-offer management plan"
- "Help me prepare a multiple-offer management plan for my next real estate conversation"
- "I need a polished multiple-offer management plan deliverable"
