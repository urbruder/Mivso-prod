---
name: highest-and-best-call-notice
description: "Use this skill whenever an agent needs a highest-and-best call notice, asks to build a highest-and-best call notice, or needs help with this catalog job: Uniform, fair, legally-sound notices to all offering agents. Produces a Word document for Highest-and-Best Call Notice."
---
...
Creates a finished Word document for Highest-and-Best Call Notice. It helps the agent handle this catalog job: Uniform, fair, legally-sound notices to all offering agents. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a highest-and-best call notice"
...
## Output Format
A Word document named Highest_and_Best_Call_Notice_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Highest-and-Best Call Notice deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Uniform, fair, legally-sound notices to all offering agents.
...
- "Build a highest-and-best call notice"
- "Create a client-ready highest-and-best call notice"
- "Turn these notes into a highest-and-best call notice"
- "Help me prepare a highest-and-best call notice for my next real estate conversation"
- "I need a polished highest-and-best call notice deliverable"
