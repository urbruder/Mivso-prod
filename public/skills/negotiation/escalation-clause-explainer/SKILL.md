---
name: escalation-clause-explainer
description: "Use this skill whenever an agent needs an escalation clause explainer, asks to build an escalation clause explainer, or needs help with this catalog job: Clear scenarios showing how an offer climbs while protecting the ceiling. Produces a Word document for Escalation Clause Explainer."
---
...
Creates a finished Word document for Escalation Clause Explainer. It helps the agent handle this catalog job: Clear scenarios showing how an offer climbs while protecting the ceiling. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build an escalation clause explainer"
...
6. Convert the source material into a polished Word document that directly supports this job: Clear scenarios showing how an offer climbs while protecting the ceiling.
...
- "Build an escalation clause explainer"
- "Create a client-ready escalation clause explainer"
- "Turn these notes into an escalation clause explainer"
- "Help me prepare an escalation clause explainer for my next real estate conversation"
- "I need a polished escalation clause explainer deliverable"
