---
name: post-close-conflict-resolver
description: "Use this skill whenever an agent needs a post-close conflict resolver, asks to build a post-close conflict resolver, or needs help with this catalog job: Defuses post-close complaints toward warranty/remedy while limiting liability. Produces a Word document for Post-Close Conflict Resolver."
---
...
Creates a finished Word document for Post-Close Conflict Resolver. It helps the agent handle this catalog job: Defuses post-close complaints toward warranty/remedy while limiting liability. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a post-close conflict resolver"
...
## Output Format
A Word document named Post_Close_Conflict_Resolver_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Post-Close Conflict Resolver deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
5. Convert the source material into a polished Word document that directly supports this job: Defuses post-close complaints toward warranty/remedy while limiting liability.
...
- "Build a post-close conflict resolver"
- "Create a client-ready post-close conflict resolver"
- "Turn these notes into a post-close conflict resolver"
- "Help me prepare a post-close conflict resolver for my next real estate conversation"
- "I need a polished post-close conflict resolver deliverable"
