---
name: negotiation-recap-email
description: "Use this skill whenever an agent needs a negotiation recap email, asks to build a negotiation recap email, or needs help with this catalog job: Documents agreed terms clearly after a negotiation to prevent disputes. Produces a Word document for Negotiation Recap Email. This is an extended catalog skill."
---
...
Creates a finished Word document for Negotiation Recap Email. It helps the agent handle this catalog job: Documents agreed terms clearly after a negotiation to prevent disputes. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a negotiation recap email"
...
## Output Format
A Word document named Negotiation_Recap_Email_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Negotiation Recap Email deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
5. Convert the source material into a polished Word document that directly supports this job: Documents agreed terms clearly after a negotiation to prevent disputes.
...
- "Build a negotiation recap email"
- "Create a client-ready negotiation recap email"
- "Turn these notes into a negotiation recap email"
- "Help me prepare a negotiation recap email for my next real estate conversation"
- "I need a polished negotiation recap email deliverable"
