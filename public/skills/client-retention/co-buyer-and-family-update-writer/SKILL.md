---
name: co-buyer-and-family-update-writer
description: "Use this skill whenever an agent needs a co-buyer & family update, asks to build a co-buyer & family update, or needs help with this catalog job: Keeps couples, parents, and attorneys aligned with permissioned updates. Produces a Word document for Co-Buyer & Family Update Writer."
---
...
Creates a finished Word document for Co-Buyer & Family Update Writer. It helps the agent handle this catalog job: Keeps couples, parents, and attorneys aligned with permissioned updates. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a co-buyer & family update"
...
## Output Format
A Word document named Co_Buyer_Family_Update_Writer_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Co-Buyer & Family Update Writer deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
5. Convert the source material into a polished Word document that directly supports this job: Keeps couples, parents, and attorneys aligned with permissioned updates.
...
- "Build a co-buyer & family update"
- "Create a client-ready co-buyer & family update"
- "Turn these notes into a co-buyer & family update"
- "Help me prepare a co-buyer & family update for my next real estate conversation"
- "I need a polished co-buyer & family update deliverable"
