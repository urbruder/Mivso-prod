---
name: offer-accepted-congrats-sequence
description: "Use this skill whenever an agent needs an offer-accepted congrats sequence, asks to build an offer-accepted congrats sequence, or needs help with this catalog job: A celebratory under-contract sequence that sets next-step expectations. Produces a Word document for Offer-Accepted Congrats Sequence. This is an extended catalog skill."
---
...
Creates a finished Word document for Offer-Accepted Congrats Sequence. It helps the agent handle this catalog job: A celebratory under-contract sequence that sets next-step expectations. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build an offer-accepted congrats sequence"
...
## Output Format
A Word document named Offer_Accepted_Congrats_Sequence_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Offer-Accepted Congrats Sequence deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
5. Convert the source material into a polished Word document that directly supports this job: A celebratory under-contract sequence that sets next-step expectations.
...
- "Build an offer-accepted congrats sequence"
- "Create a client-ready offer-accepted congrats sequence"
- "Turn these notes into an offer-accepted congrats sequence"
- "Help me prepare an offer-accepted congrats sequence for my next real estate conversation"
- "I need a polished offer-accepted congrats sequence deliverable"
