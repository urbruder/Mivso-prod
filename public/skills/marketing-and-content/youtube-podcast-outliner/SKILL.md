---
name: youtube-podcast-outliner
description: "Use this skill whenever an agent needs a youtube and podcast outliner, asks to build a youtube and podcast outliner, or needs help with this catalog job: Episode outlines and hooks for long-form agent content. Produces a Word document for YouTube / Podcast Outliner. This is an extended catalog skill."
---
...
Creates a finished Word document for YouTube / Podcast Outliner. It helps the agent handle this catalog job: Episode outlines and hooks for long-form agent content. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a youtube and podcast outliner"
...
## Output Format
A Word document named YouTube_Podcast_Outliner_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main YouTube / Podcast Outliner deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Episode outlines and hooks for long-form agent content.
...
- "Build a youtube and podcast outliner"
- "Create a client-ready youtube and podcast outliner"
- "Turn these notes into a youtube and podcast outliner"
- "Help me prepare a youtube and podcast outliner for my next real estate conversation"
- "I need a polished youtube and podcast outliner deliverable"
