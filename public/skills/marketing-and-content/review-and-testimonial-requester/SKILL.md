---
name: review-and-testimonial-requester
description: "Use this skill whenever an agent needs a review & testimonial requester, asks to build a review & testimonial requester, or needs help with this catalog job: Timed, specific review requests at the peak emotional moment. Produces a Word document for Review & Testimonial Requester."
---
...
Creates a finished Word document for Review & Testimonial Requester. It helps the agent handle this catalog job: Timed, specific review requests at the peak emotional moment. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a review & testimonial requester"
...
## Output Format
A Word document named Review_Testimonial_Requester_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Review & Testimonial Requester deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Timed, specific review requests at the peak emotional moment.
...
- "Build a review & testimonial requester"
- "Create a client-ready review & testimonial requester"
- "Turn these notes into a review & testimonial requester"
- "Help me prepare a review & testimonial requester for my next real estate conversation"
- "I need a polished review & testimonial requester deliverable"
