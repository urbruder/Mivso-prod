---
name: listing-photo-shot-list
description: "Use this skill whenever an agent needs a listing photo shot list, asks to build a listing photo shot list, or needs help with this catalog job: Generates a room-by-room shot list for the photographer. Produces an Excel workbook for Listing Photo Shot List. This is an extended catalog skill."
---
...
Creates a finished Excel workbook for Listing Photo Shot List. It helps the agent handle this catalog job: Generates a room-by-room shot list for the photographer. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a listing photo shot list"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Generates a room-by-room shot list for the photographer.
...
- "Build a listing photo shot list"
- "Create a client-ready listing photo shot list"
- "Turn these notes into a listing photo shot list"
- "Help me prepare a listing photo shot list for my next real estate conversation"
- "I need a polished listing photo shot list deliverable"
