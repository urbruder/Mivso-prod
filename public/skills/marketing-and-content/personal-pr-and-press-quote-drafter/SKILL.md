---
name: personal-pr-and-press-quote-drafter
description: "Use this skill whenever an agent needs a personal pr & press quote drafter, asks to build a personal pr & press quote drafter, or needs help with this catalog job: Quote-ready soundbites that position you as a market authority. Produces a Word document for Personal PR & Press Quote Drafter."
---
...
Creates a finished Word document for Personal PR & Press Quote Drafter. It helps the agent handle this catalog job: Quote-ready soundbites that position you as a market authority. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a personal pr & press quote drafter"
...
## Output Format
A Word document named Personal_PR_Press_Quote_Drafter_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Personal PR & Press Quote Drafter deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Quote-ready soundbites that position you as a market authority.
...
- "Build a personal pr & press quote drafter"
- "Create a client-ready personal pr & press quote drafter"
- "Turn these notes into a personal pr & press quote drafter"
- "Help me prepare a personal pr & press quote drafter for my next real estate conversation"
- "I need a polished personal pr & press quote drafter deliverable"
