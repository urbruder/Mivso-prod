...
description: "Use this skill whenever an agent needs a monthly market update, asks to build a monthly market update, or needs help with this catalog job: Local stats turned into a clear buyer-and-seller authority piece. Produces a Formatted HTML visual for Monthly Market Update."
---
...
Creates a finished Formatted HTML visual for Monthly Market Update. It helps the agent handle this catalog job: Local stats turned into a clear buyer-and-seller authority piece. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a monthly market update"
...
## Output Format
A formatted HTML visual named Monthly_Market_Update_with_date.html. The layout must include a branded header, executive summary cards, a clean comparison or recommendation table, a main narrative section, callout boxes for risks and opportunities, and a final next-step checklist. The visual must be readable as a one-page digital brief or printable PDF-style page.
...
6. Convert the source material into a polished Formatted HTML visual that directly supports this job: Local stats turned into a clear buyer-and-seller authority piece.
...
- "Build a monthly market update"
- "Create a client-ready monthly market update"
- "Turn these notes into a monthly market update"
- "Help me prepare a monthly market update for my next real estate conversation"
- "I need a polished monthly market update deliverable"
