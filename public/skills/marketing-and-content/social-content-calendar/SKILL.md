...
description: "Use this skill whenever an agent needs a social content calendar, asks to build a social content calendar, or needs help with this catalog job: A full month of platform-specific posts across all channels. Produces an Excel workbook for Social Content Calendar."
---
...
Creates a finished Excel workbook for Social Content Calendar. It helps the agent handle this catalog job: A full month of platform-specific posts across all channels. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a social content calendar"
...
## Output Format
An Excel workbook named Social_Content_Calendar_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Social Content Calendar; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: A full month of platform-specific posts across all channels.
...
- "Create a client-ready social content calendar"
- "Turn these notes into a social content calendar"
- "Help me prepare a social content calendar for my next real estate conversation"
- "I need a polished social content calendar deliverable"
