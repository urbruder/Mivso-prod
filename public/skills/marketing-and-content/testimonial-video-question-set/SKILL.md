---
name: testimonial-video-question-set
description: "Use this skill whenever an agent needs a testimonial video question set, asks to build a testimonial video question set, or needs help with this catalog job: Interview questions that get clients to tell a compelling story. Produces a Word document for Testimonial Video Question Set. This is an extended catalog skill."
---
...
Creates a finished Word document for Testimonial Video Question Set. It helps the agent handle this catalog job: Interview questions that get clients to tell a compelling story. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a testimonial video question set"
...
## Output Format
A Word document named Testimonial_Video_Question_Set_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Testimonial Video Question Set deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Interview questions that get clients to tell a compelling story.
...
- "Build a testimonial video question set"
- "Create a client-ready testimonial video question set"
- "Turn these notes into a testimonial video question set"
- "Help me prepare a testimonial video question set for my next real estate conversation"
- "I need a polished testimonial video question set deliverable"
