---
name: listing-media-shoot-brief
description: "Use this skill whenever an agent needs a listing media shoot brief, asks to build a listing media shoot brief, or needs help with this catalog job: Shot list and coordination for photo, drone, and twilight shoots. Produces a Word document for Listing Media Shoot Brief."
---
...
Creates a finished Word document for Listing Media Shoot Brief. It helps the agent handle this catalog job: Shot list and coordination for photo, drone, and twilight shoots. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a listing media shoot brief"
...
## Output Format
A Word document named Listing_Media_Shoot_Brief_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Listing Media Shoot Brief deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Shot list and coordination for photo, drone, and twilight shoots.
...
- "Build a listing media shoot brief"
- "Create a client-ready listing media shoot brief"
- "Turn these notes into a listing media shoot brief"
- "Help me prepare a listing media shoot brief for my next real estate conversation"
- "I need a polished listing media shoot brief deliverable"
