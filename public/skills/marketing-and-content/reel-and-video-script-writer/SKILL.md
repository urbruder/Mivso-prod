---
name: reel-and-video-script-writer
description: "Use this skill whenever an agent needs a reel & video script, asks to build a reel & video script, or needs help with this catalog job: Short-form scripts with hooks engineered for the first three seconds. Produces a Word document for Reel & Video Script Writer."
---
...
Creates a finished Word document for Reel & Video Script Writer. It helps the agent handle this catalog job: Short-form scripts with hooks engineered for the first three seconds. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a reel & video script"
...
## Output Format
A Word document named Reel_Video_Script_Writer_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Reel & Video Script Writer deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Short-form scripts with hooks engineered for the first three seconds.
...
- "Build a reel & video script"
- "Create a client-ready reel & video script"
- "Turn these notes into a reel & video script"
- "Help me prepare a reel & video script for my next real estate conversation"
- "I need a polished reel & video script deliverable"
