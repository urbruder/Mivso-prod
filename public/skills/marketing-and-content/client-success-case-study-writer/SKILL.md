---
name: client-success-case-study-writer
description: "Use this skill whenever an agent needs a client success case-study, asks to build a client success case-study, or needs help with this catalog job: Turns a closed deal into a shareable success story. Produces a Word document for Client Success Case-Study Writer. This is an extended catalog skill."
---
...
## Output Format
A Word document named Client_Success_Case_Study_Writer_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Client Success Case-Study Writer deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Turns a closed deal into a shareable success story.
...
- "Build a client success case-study"
- "Create a client-ready client success case-study"
- "Turn these notes into a client success case-study"
- "Help me prepare a client success case-study for my next real estate conversation"
- "I need a polished client success case-study deliverable"
