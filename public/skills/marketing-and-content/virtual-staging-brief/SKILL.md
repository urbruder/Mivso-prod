---
name: virtual-staging-brief
description: "Use this skill whenever an agent needs a virtual staging brief, asks to build a virtual staging brief, or needs help with this catalog job: Specs virtual-staging shots and disclosures for vacant listings. Produces a Word document for Virtual Staging Brief. This is an extended catalog skill."
---
...
Creates a finished Word document for Virtual Staging Brief. It helps the agent handle this catalog job: Specs virtual-staging shots and disclosures for vacant listings. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a virtual staging brief"
...
## Output Format
A Word document named Virtual_Staging_Brief_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Virtual Staging Brief deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Specs virtual-staging shots and disclosures for vacant listings.
...
- "Build a virtual staging brief"
- "Create a client-ready virtual staging brief"
- "Turn these notes into a virtual staging brief"
- "Help me prepare a virtual staging brief for my next real estate conversation"
- "I need a polished virtual staging brief deliverable"
