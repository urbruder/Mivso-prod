---
name: showing-scheduler-and-coordinator
description: "Use this skill whenever an agent needs a showing scheduler & coordinator, asks to build a showing scheduler & coordinator, or needs help with this catalog job: Coordinates buyer, seller, and both agents across calendars. Produces a Word document for Showing Scheduler & Coordinator."
---
...
Creates a finished Word document for Showing Scheduler & Coordinator. It helps the agent handle this catalog job: Coordinates buyer, seller, and both agents across calendars. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a showing scheduler & coordinator"
...
## Output Format
A Word document named Showing_Scheduler_Coordinator_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Showing Scheduler & Coordinator deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Coordinates buyer, seller, and both agents across calendars.
...
- "Build a showing scheduler & coordinator"
- "Create a client-ready showing scheduler & coordinator"
- "Turn these notes into a showing scheduler & coordinator"
- "Help me prepare a showing scheduler & coordinator for my next real estate conversation"
- "I need a polished showing scheduler & coordinator deliverable"
