---
name: vendor-accountability-nudge
description: "Use this skill whenever an agent needs a vendor accountability nudge, asks to build a vendor accountability nudge, or needs help with this catalog job: Firm-but-professional emails that get late lenders and vendors moving. Produces a Word document for Vendor Accountability Nudge."
---
...
Creates a finished Word document for Vendor Accountability Nudge. It helps the agent handle this catalog job: Firm-but-professional emails that get late lenders and vendors moving. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a vendor accountability nudge"
...
## Output Format
A Word document named Vendor_Accountability_Nudge_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Vendor Accountability Nudge deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Firm-but-professional emails that get late lenders and vendors moving.
...
- "Build a vendor accountability nudge"
- "Create a client-ready vendor accountability nudge"
- "Turn these notes into a vendor accountability nudge"
- "Help me prepare a vendor accountability nudge for my next real estate conversation"
- "I need a polished vendor accountability nudge deliverable"
