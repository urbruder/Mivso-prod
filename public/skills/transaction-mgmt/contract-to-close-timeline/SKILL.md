---
name: contract-to-close-timeline
description: "Use this skill whenever an agent needs a contract-to-close timeline, asks to build a contract-to-close timeline, or needs help with this catalog job: Milestone timeline with deadline reminders for either side of the deal. Produces an Excel workbook for Contract-to-Close Timeline."
---
...
Creates a finished Excel workbook for Contract-to-Close Timeline. It helps the agent handle this catalog job: Milestone timeline with deadline reminders for either side of the deal. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a contract-to-close timeline"
...
## Output Format
An Excel workbook named Contract_to_Close_Timeline_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Contract-to-Close Timeline; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Milestone timeline with deadline reminders for either side of the deal.
...
- "Build a contract-to-close timeline"
- "Create a client-ready contract-to-close timeline"
- "Turn these notes into a contract-to-close timeline"
- "Help me prepare a contract-to-close timeline for my next real estate conversation"
- "I need a polished contract-to-close timeline deliverable"
