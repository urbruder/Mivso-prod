---
name: move-in-day-blueprint
description: "Use this skill whenever an agent needs a move-in day blueprint, asks to build a move-in day blueprint, or needs help with this catalog job: Municipality-specific utility, parking, and registration checklist. Produces a Word document for Move-In Day Blueprint."
---
...
Creates a finished Word document for Move-In Day Blueprint. It helps the agent handle this catalog job: Municipality-specific utility, parking, and registration checklist. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a move-in day blueprint"
...
## Output Format
A Word document named Move_In_Day_Blueprint_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Move-In Day Blueprint deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Municipality-specific utility, parking, and registration checklist.
...
- "Build a move-in day blueprint"
- "Create a client-ready move-in day blueprint"
- "Turn these notes into a move-in day blueprint"
- "Help me prepare a move-in day blueprint for my next real estate conversation"
- "I need a polished move-in day blueprint deliverable"
