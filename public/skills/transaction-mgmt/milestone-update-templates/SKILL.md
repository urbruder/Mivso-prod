---
name: milestone-update-templates
description: "Use this skill whenever an agent needs a milestone update templates, asks to build a milestone update templates, or needs help with this catalog job: Ready client updates for every stage so no one panics in the silence. Produces a Word document for Milestone Update Templates."
---
...
Creates a finished Word document for Milestone Update Templates. It helps the agent handle this catalog job: Ready client updates for every stage so no one panics in the silence. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a milestone update templates"
...
## Output Format
A Word document named Milestone_Update_Templates_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Milestone Update Templates deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Ready client updates for every stage so no one panics in the silence.
...
- "Build a milestone update templates"
- "Create a client-ready milestone update templates"
- "Turn these notes into a milestone update templates"
- "Help me prepare a milestone update templates for my next real estate conversation"
- "I need a polished milestone update templates deliverable"
