---
name: final-walkthrough-and-closing-prep
description: "Use this skill whenever an agent needs a final walkthrough & closing prep, asks to build a final walkthrough & closing prep, or needs help with this catalog job: Walkthrough checklist and a what-to-expect briefing for signing day. Produces a Word document for Final Walkthrough & Closing Prep."
---
...
Creates a finished Word document for Final Walkthrough & Closing Prep. It helps the agent handle this catalog job: Walkthrough checklist and a what-to-expect briefing for signing day. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a final walkthrough & closing prep"
...
## Output Format
A Word document named Final_Walkthrough_Closing_Prep_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Final Walkthrough & Closing Prep deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Walkthrough checklist and a what-to-expect briefing for signing day.
...
- "Build a final walkthrough & closing prep"
- "Create a client-ready final walkthrough & closing prep"
- "Turn these notes into a final walkthrough & closing prep"
- "Help me prepare a final walkthrough & closing prep for my next real estate conversation"
- "I need a polished final walkthrough & closing prep deliverable"
