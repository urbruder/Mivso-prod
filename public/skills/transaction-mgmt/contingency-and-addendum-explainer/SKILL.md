---
name: contingency-and-addendum-explainer
description: "Use this skill whenever an agent needs a contingency & addendum explainer, asks to build a contingency & addendum explainer, or needs help with this catalog job: Plain-English explanations of the clauses clients are about to sign. Produces a Word document for Contingency & Addendum Explainer."
---
...
Creates a finished Word document for Contingency & Addendum Explainer. It helps the agent handle this catalog job: Plain-English explanations of the clauses clients are about to sign. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a contingency & addendum explainer"
...
## Output Format
A Word document named Contingency_Addendum_Explainer_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Contingency & Addendum Explainer deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Plain-English explanations of the clauses clients are about to sign.
...
- "Build a contingency & addendum explainer"
- "Create a client-ready contingency & addendum explainer"
- "Turn these notes into a contingency & addendum explainer"
- "Help me prepare a contingency & addendum explainer for my next real estate conversation"
- "I need a polished contingency & addendum explainer deliverable"
