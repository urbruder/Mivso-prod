---
name: preferred-vendor-sheet-builder
description: "Use this skill whenever an agent needs a preferred vendor sheet, asks to build a preferred vendor sheet, or needs help with this catalog job: Branded, organized referral sheet plus warm intro messages. Produces an Excel workbook for Preferred Vendor Sheet Builder."
---
...
Creates a finished Excel workbook for Preferred Vendor Sheet Builder. It helps the agent handle this catalog job: Branded, organized referral sheet plus warm intro messages. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a preferred vendor sheet"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Branded, organized referral sheet plus warm intro messages.
...
- "Build a preferred vendor sheet"
- "Create a client-ready preferred vendor sheet"
- "Turn these notes into a preferred vendor sheet"
- "Help me prepare a preferred vendor sheet for my next real estate conversation"
- "I need a polished preferred vendor sheet deliverable"
