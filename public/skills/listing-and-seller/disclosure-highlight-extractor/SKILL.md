---
name: disclosure-highlight-extractor
description: "Use this skill whenever an agent needs a disclosure highlight extractor, asks to build a disclosure highlight extractor, or needs help with this catalog job: Mines messy seller disclosures for sellable upgrades and red flags. Produces an Excel workbook for Disclosure Highlight Extractor."
---
...
Creates a finished Excel workbook for Disclosure Highlight Extractor. It helps the agent handle this catalog job: Mines messy seller disclosures for sellable upgrades and red flags. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a disclosure highlight extractor"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Mines messy seller disclosures for sellable upgrades and red flags.
...
- "Build a disclosure highlight extractor"
- "Create a client-ready disclosure highlight extractor"
- "Turn these notes into a disclosure highlight extractor"
- "Help me prepare a disclosure highlight extractor for my next real estate conversation"
- "I need a polished disclosure highlight extractor deliverable"
