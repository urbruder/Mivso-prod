---
name: comp-selection-and-adjustment-helper
description: "Use this skill whenever an agent needs a comp selection & adjustment helper, asks to build a comp selection & adjustment helper, or needs help with this catalog job: Normalizes and adjusts comps for a defensible price in under an hour. Produces an Excel workbook for Comp Selection & Adjustment Helper."
---
...
Creates a finished Excel workbook for Comp Selection & Adjustment Helper. It helps the agent handle this catalog job: Normalizes and adjusts comps for a defensible price in under an hour. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a comp selection & adjustment helper"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Normalizes and adjusts comps for a defensible price in under an hour.
...
- "Build a comp selection & adjustment helper"
- "Create a client-ready comp selection & adjustment helper"
- "Turn these notes into a comp selection & adjustment helper"
- "Help me prepare a comp selection & adjustment helper for my next real estate conversation"
- "I need a polished comp selection & adjustment helper deliverable"
