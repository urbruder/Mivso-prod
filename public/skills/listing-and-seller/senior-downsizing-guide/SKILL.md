---
name: senior-downsizing-guide
description: "Use this skill whenever an agent needs a senior downsizing guide, asks to build a senior downsizing guide, or needs help with this catalog job: Empathetic downsizing roadmap for senior sellers and their families. Produces a Word document for Senior Downsizing Guide. This is an extended catalog skill."
---
...
Creates a finished Word document for Senior Downsizing Guide. It helps the agent handle this catalog job: Empathetic downsizing roadmap for senior sellers and their families. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a senior downsizing guide"
...
6. Convert the source material into a polished Word document that directly supports this job: Empathetic downsizing roadmap for senior sellers and their families.
...
- "Build a senior downsizing guide"
- "Create a client-ready senior downsizing guide"
- "Turn these notes into a senior downsizing guide"
- "Help me prepare a senior downsizing guide for my next real estate conversation"
- "I need a polished senior downsizing guide deliverable"
