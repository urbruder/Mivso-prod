---
name: seller-net-sheet-explainer
description: "Use this skill whenever an agent needs a seller net sheet explainer, asks to build a seller net sheet explainer, or needs help with this catalog job: Plain-English walkthrough of every net-sheet line item — no closing surprises. Produces an Excel workbook for Seller Net Sheet Explainer."
---
...
Creates a finished Excel workbook for Seller Net Sheet Explainer. It helps the agent handle this catalog job: Plain-English walkthrough of every net-sheet line item — no closing surprises. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a seller net sheet explainer"
...
## Output Format
An Excel workbook named Seller_Net_Sheet_Explainer_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Seller Net Sheet Explainer; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Plain-English walkthrough of every net-sheet line item — no closing surprises.
...
- "Build a seller net sheet explainer"
- "Create a client-ready seller net sheet explainer"
- "Turn these notes into a seller net sheet explainer"
- "Help me prepare a seller net sheet explainer for my next real estate conversation"
- "I need a polished seller net sheet explainer deliverable"
