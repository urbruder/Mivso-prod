---
name: land-lot-sale-guide
description: "Use this skill whenever an agent needs a land and lot sale guide, asks to build a land and lot sale guide, or needs help with this catalog job: Positioning and due-diligence guide specific to raw-land sales. Produces a Word document for Land / Lot Sale Guide. This is an extended catalog skill."
---
...
Creates a finished Word document for Land / Lot Sale Guide. It helps the agent handle this catalog job: Positioning and due-diligence guide specific to raw-land sales. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a land and lot sale guide"
...
## Output Format
A Word document named Land_Lot_Sale_Guide_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Land / Lot Sale Guide deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Positioning and due-diligence guide specific to raw-land sales.
...
- "Build a land and lot sale guide"
- "Create a client-ready land and lot sale guide"
- "Turn these notes into a land and lot sale guide"
- "Help me prepare a land and lot sale guide for my next real estate conversation"
- "I need a polished land and lot sale guide deliverable"
