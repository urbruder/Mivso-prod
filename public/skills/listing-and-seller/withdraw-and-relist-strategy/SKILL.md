---
name: withdraw-and-relist-strategy
description: "Use this skill whenever an agent needs a withdraw & relist strategy, asks to build a withdraw & relist strategy, or needs help with this catalog job: Advises whether and how to refresh DOM with a relist. Produces a Word document for Withdraw & Relist Strategy. This is an extended catalog skill."
---
...
Creates a finished Word document for Withdraw & Relist Strategy. It helps the agent handle this catalog job: Advises whether and how to refresh DOM with a relist. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a withdraw & relist strategy"
...
6. Convert the source material into a polished Word document that directly supports this job: Advises whether and how to refresh DOM with a relist.
...
- "Build a withdraw & relist strategy"
- "Create a client-ready withdraw & relist strategy"
- "Turn these notes into a withdraw & relist strategy"
- "Help me prepare a withdraw & relist strategy for my next real estate conversation"
- "I need a polished withdraw & relist strategy deliverable"
