---
name: days-on-market-recovery-plan
description: "Use this skill whenever an agent needs a days-on-market recovery plan, asks to build a days-on-market recovery plan, or needs help with this catalog job: Diagnoses a stale listing and prescribes price/staging/marketing fixes. Produces an Excel workbook for Days-on-Market Recovery Plan. This is an extended catalog skill."
---
...
Creates a finished Excel workbook for Days-on-Market Recovery Plan. It helps the agent handle this catalog job: Diagnoses a stale listing and prescribes price/staging/marketing fixes. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a days-on-market recovery plan"
...
## Output Format
An Excel workbook named Days_on_Market_Recovery_Plan_with_date.xlsx with five polished sheets: (1) Dashboard - a one-page visual summary with key decisions, risk flags, totals, and next actions; (2) Source Inputs - the facts, documents, assumptions, and notes supplied by the agent; (3) Analysis Matrix - the main comparison, checklist, tracker, scoring table, or calculation model for Days-on-Market Recovery Plan; (4) Action Plan - owner, due date, priority, status, and follow-up columns; (5) Client or Team Notes - plain-English talking points and verification reminders. Format with frozen headers, readable column widths, wrapped notes, status labels, and a print-ready summary area.
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Diagnoses a stale listing and prescribes price/staging/marketing fixes.
...
- "Build a days-on-market recovery plan"
- "Create a client-ready days-on-market recovery plan"
- "Turn these notes into a days-on-market recovery plan"
- "Help me prepare a days-on-market recovery plan for my next real estate conversation"
- "I need a polished days-on-market recovery plan deliverable"
