...
description: "Use this skill whenever an agent needs a listing description, asks to build a listing description, or needs help with this catalog job: Compelling, Fair-Housing-safe MLS copy in multiple lengths from a feature list. Produces a Word document for Listing Description Writer."
---
...
Creates a finished Word document for Listing Description Writer. It helps the agent handle this catalog job: Compelling, Fair-Housing-safe MLS copy in multiple lengths from a feature list. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a listing description"
...
## Output Format
A Word document named Listing_Description_Writer_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Listing Description Writer deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Compelling, Fair-Housing-safe MLS copy in multiple lengths from a feature list.
...
- "Build a listing description"
- "Create a client-ready listing description"
- "Turn these notes into a listing description"
- "Help me prepare a listing description for my next real estate conversation"
- "I need a polished listing description deliverable"
