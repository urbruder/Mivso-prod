---
name: divorce-sale-navigator
description: "Use this skill whenever an agent needs a divorce sale navigator, asks to build a divorce sale navigator, or needs help with this catalog job: Neutral process and dual-client comms for a divorce-driven sale. Produces a Word document for Divorce Sale Navigator. This is an extended catalog skill."
---
...
Creates a finished Word document for Divorce Sale Navigator. It helps the agent handle this catalog job: Neutral process and dual-client comms for a divorce-driven sale. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a divorce sale navigator"
...
## Output Format
A Word document named Divorce_Sale_Navigator_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Divorce Sale Navigator deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Neutral process and dual-client comms for a divorce-driven sale.
...
- "Build a divorce sale navigator"
- "Create a client-ready divorce sale navigator"
- "Turn these notes into a divorce sale navigator"
- "Help me prepare a divorce sale navigator for my next real estate conversation"
- "I need a polished divorce sale navigator deliverable"
