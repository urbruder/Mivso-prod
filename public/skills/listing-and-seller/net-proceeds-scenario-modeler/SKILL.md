---
name: net-proceeds-scenario-modeler
description: "Use this skill whenever an agent needs a net-proceeds scenario modeler, asks to build a net-proceeds scenario modeler, or needs help with this catalog job: Models seller net across multiple price and concession scenarios. Produces an Excel workbook for Net-Proceeds Scenario Modeler. This is an extended catalog skill."
---
...
Creates a finished Excel workbook for Net-Proceeds Scenario Modeler. It helps the agent handle this catalog job: Models seller net across multiple price and concession scenarios. The output is formatted so it can be reviewed, shared, printed, or used in a client, team, broker, investor, vendor, borrower, owner, or title conversation without another formatting pass.

## How to Run This Skill
1. Tell Claude: "Build a net-proceeds scenario modeler"
...
7. Convert the source material into a polished Excel workbook that directly supports this job: Models seller net across multiple price and concession scenarios.
...
- "Build a net-proceeds scenario modeler"
- "Create a client-ready net-proceeds scenario modeler"
- "Turn these notes into a net-proceeds scenario modeler"
- "Help me prepare a net-proceeds scenario modeler for my next real estate conversation"
- "I need a polished net-proceeds scenario modeler deliverable"
