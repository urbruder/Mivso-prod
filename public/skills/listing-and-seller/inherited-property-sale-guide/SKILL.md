---
name: inherited-property-sale-guide
description: "Use this skill whenever an agent needs an inherited-property sale guide, asks to build an inherited-property sale guide, or needs help with this catalog job: Probate-aware workflow, heir comms, and timeline for inherited homes. Produces a Word document for Inherited-Property Sale Guide. This is an extended catalog skill."
---
...
## Output Format
A Word document named Inherited_Property_Sale_Guide_with_date.docx with a polished cover heading, a short executive summary, an input snapshot, the main Inherited-Property Sale Guide deliverable, client-facing language or talking points, risk and compliance notes, and a final next-step checklist. Use headings, tables, bullets, and short paragraphs so the agent can print, email, or use the document in a meeting. Approximate length: 4-8 pages unless the supplied materials require more detail.
...
6. Convert the source material into a polished Word document that directly supports this job: Probate-aware workflow, heir comms, and timeline for inherited homes.
...
- "Build an inherited-property sale guide"
- "Create a client-ready inherited-property sale guide"
- "Turn these notes into an inherited-property sale guide"
- "Help me prepare an inherited-property sale guide for my next real estate conversation"
- "I need a polished inherited-property sale guide deliverable"
