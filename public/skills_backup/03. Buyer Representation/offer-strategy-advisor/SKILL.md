# MIVSO Skill: Offer Strategy Advisor
System prompt and integration instructions for the Offer Strategy Advisor AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Offer Strategy Advisor".
