# MIVSO Skill: Multiple Offer Manager
System prompt and integration instructions for the Multiple Offer Manager AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Multiple Offer Manager".
