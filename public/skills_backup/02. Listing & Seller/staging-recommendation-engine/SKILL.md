# MIVSO Skill: Staging Recommendation Engine
System prompt and integration instructions for the Staging Recommendation Engine AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Staging Recommendation Engine".
