# MIVSO Skill: Cma Narrative Builder
System prompt and integration instructions for the Cma Narrative Builder AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Cma Narrative Builder".
