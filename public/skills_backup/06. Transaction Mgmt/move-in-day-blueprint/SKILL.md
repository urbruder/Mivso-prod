# MIVSO Skill: Move In Day Blueprint
System prompt and integration instructions for the Move In Day Blueprint AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Move In Day Blueprint".
