# MIVSO Skill: Showing Scheduler Coordinator
System prompt and integration instructions for the Showing Scheduler Coordinator AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Showing Scheduler Coordinator".
