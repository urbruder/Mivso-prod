# MIVSO Skill: Newsletter Ghostwriter
System prompt and integration instructions for the Newsletter Ghostwriter AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Newsletter Ghostwriter".
