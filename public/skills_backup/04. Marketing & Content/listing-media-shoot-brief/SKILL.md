# MIVSO Skill: Listing Media Shoot Brief
System prompt and integration instructions for the Listing Media Shoot Brief AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Listing Media Shoot Brief".
