# MIVSO Skill: Monthly Market Update
System prompt and integration instructions for the Monthly Market Update AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Monthly Market Update".
