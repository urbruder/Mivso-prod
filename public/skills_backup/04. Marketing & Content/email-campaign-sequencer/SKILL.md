# MIVSO Skill: Email Campaign Sequencer
System prompt and integration instructions for the Email Campaign Sequencer AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Email Campaign Sequencer".
