# MIVSO Skill: Review Testimonial Requester
System prompt and integration instructions for the Review Testimonial Requester AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Review Testimonial Requester".
