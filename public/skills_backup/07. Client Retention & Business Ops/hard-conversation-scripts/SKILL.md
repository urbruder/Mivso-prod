# MIVSO Skill: Hard Conversation Scripts
System prompt and integration instructions for the Hard Conversation Scripts AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Hard Conversation Scripts".
