# MIVSO Skill: Voice Note Polished Email
System prompt and integration instructions for the Voice Note Polished Email AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Voice Note Polished Email".
