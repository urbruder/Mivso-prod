# MIVSO Skill: Relocation Orientation Guide
System prompt and integration instructions for the Relocation Orientation Guide AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Relocation Orientation Guide".
