# MIVSO Skill: Weekly Business Planner
System prompt and integration instructions for the Weekly Business Planner AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Weekly Business Planner".
