# MIVSO Skill: Commission Split Calculator
System prompt and integration instructions for the Commission Split Calculator AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Commission Split Calculator".
