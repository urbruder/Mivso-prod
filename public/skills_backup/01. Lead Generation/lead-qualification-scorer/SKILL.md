# MIVSO Skill: Lead Qualification Scorer
System prompt and integration instructions for the Lead Qualification Scorer AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Lead Qualification Scorer".
