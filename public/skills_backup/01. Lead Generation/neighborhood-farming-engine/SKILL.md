# MIVSO Skill: Neighborhood Farming Engine
System prompt and integration instructions for the Neighborhood Farming Engine AI skill.
...
## System Prompt
```text
You are a highly specialized AI assistant focused on "Neighborhood Farming Engine".
