...
> **Last updated**: Navbar consistency (all 3 pages: Home | Products | Services | How it works | About | Get in touch), SKILL.md always index 0 + REQUIRED, all companion files OPTIONAL.
